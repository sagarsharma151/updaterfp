...
const appsNavTree = [{
  key: 'liveopportunities',
  path: `${APP_PREFIX_PATH}/liveopportunities`,
  title: 'sidenav.liveopportunities',
  breadcrumb: false,
  submenu: [
    // {
    //   key: 'apps-mail',
...
const recommendedOpportunities = [{
  key: 'recommendedOpportunities',
  path: `${APP_PREFIX_PATH}/recommendedOpportunities`,
  title: 'sidenav.recommendedOpportunities',
  breadcrumb: false,
  submenu: []
}]
...
const pipeline = [{
  key: 'pipeline',
  path: `${APP_PREFIX_PATH}/pipeline`,
  title: 'sidenav.pipeline',
  breadcrumb: false,
  submenu: []
}]
...
const teamingPartners = [{
  key: 'teamingPartners',
  path: `${APP_PREFIX_PATH}/teamingPartners`,
  title: 'sidenav.teamingPartners',
  breadcrumb: false,
  submenu: []
}]
...
const incumbentSearch = [{
  key: 'incumbentSearch',
  path: `${APP_PREFIX_PATH}/incumbentSearch`,
  title: 'sidenav.incumbentSearch',
  breadcrumb: false,
  submenu: []
}]
...
const spendAnalytics = [{
  key: 'spendAnalytics',
  path: `${APP_PREFIX_PATH}/spendAnalytics`,
  title: 'sidenav.spendAnalytics',
  breadcrumb: false,
  submenu: []
}]
...
const farLibrary = [{
  key: 'farLibrary',
  path: `${APP_PREFIX_PATH}/farLibrary`,
  title: 'sidenav.farLibrary',
  breadcrumb: false,
  submenu: []
}]
...
const resourcesEvents = [{
  key: 'resourcesEvents',
  path: `${APP_PREFIX_PATH}/resourcesEvents`,
  title: 'sidenav.resourcesEvents',
  breadcrumb: false,
  submenu: []
}]
...
const priceIntelligence = [{
  ...
  path: `${APP_PREFIX_PATH}/priceIntelligence`,
  title: 'sidenav.priceIntelligence',
  breadcrumb: false,
  submenu: []
}]

const agencyForecasts = [{
  key: 'agencyForecasts',
  path: `${APP_PREFIX_PATH}/agencyForecasts`,
  title: 'sidenav.agencyForecasts',
  breadcrumb: false,
  submenu: []
}]
...
const foiaRequests = [{
  key: 'foiaRequests',
  path: `${APP_PREFIX_PATH}/foiaRequests`,
  title: 'sidenav.foiaRequests',
  breadcrumb: false,
  submenu: []
}]
